...
stick = Item("Stick", constants.stick_sprite, 0, 0, constants.stick_sprite_inv, 5, dmg = 2, description = "Regular wooden stick")
...
metal_armor = Item("Metal armor", constants.metal_armor_sprite, 0, 0, constants.metal_armor_sprite_inv, 10, armor = 10, slot = "armor_slot", description = "Slightley rusty")
...
metal_helmet = Item("Metal helmet", constants.metal_helmet_sprite, 0, 0, constants.metal_helmet_sprite_inv, 10, armor = 7, slot = "helmet_slot", description = "These are quite nice slippers")
